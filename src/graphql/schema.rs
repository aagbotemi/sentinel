...
//             .bind(input.from_sender)
//             .bind(input.to_reciever)
//             .bind(input.tx_value)
//             .bind(input.gas)
//             .bind(input.gas_price)
//             .bind(input.input)
//             .bind(input.nonce)
//             .bind(input.mempool_time)
...
//             from_sender: result.from_sender,
//             to_reciever: result.to_reciever,
//             tx_value: result.tx_value,
//             gas: result.gas,
//             gas_price: result.gas_price,
//             input: result.input,
//             nonce: result.nonce,
//             mempool_time: result.mempool_time,
